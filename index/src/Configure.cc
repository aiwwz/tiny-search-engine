...
void Configure::defaultConfig() {
    ...
    m_configMap["ripepagelib"] = "../data/pagelib.dat"; //网页库
    m_configMap["offsetlib"] = "../data/offsetlib.dat"; //网页偏移库
    m_configMap["newpagelib"] = "../data/newpagelib.dat"; //去重之后的网页库
    m_configMap["newoffsetlib"] = "../data/newoffsetlib.dat"; //去重之后的网页偏移库
...
set<string> Configure::getStopWords() const {
    return m_stopWords;
}
